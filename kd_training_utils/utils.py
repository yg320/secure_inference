...
import os
import sys
from kd_training_utils.datasets import get_dataset, DATASETS, get_num_classes
...
from kd_training_utils.train_utils import AverageMeter, accuracy, accuracy_list
...
def mask_train_kd(loader: DataLoader, model: torch.nn.Module, model_teacher: torch.nn.Module, criterion,
                  optimizer: Optimizer,
                  epoch: int, device, alpha, display=False):
    losses = AverageMeter()
...
def mask_train_kd_unstructured(loader: DataLoader, model: torch.nn.Module, model_teacher: torch.nn.Module, criterion,
                               optimizer: Optimizer,
                               epoch: int, device, alpha, display=False):
    losses = AverageMeter()
