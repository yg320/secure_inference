...
from kd_training_utils.init_utils import weights_init

from torch.autograd import Variable

__all__ = ['ResNet', 'resnet34_in', 'resnet50_in', 'resnet18_in', 'resnet9_in',
           'wide_resnet22_8', 'wide_resnet_22_8_drop02', 'wide_resnet_28_10_drop02', 'wide_resnet_28_12_drop02',
           'wide_resnet_16_8_drop02'
...
class NetworkBlock(nn.Module):
    ...
    def _make_layer(self, block, in_planes, out_planes, nb_layers, stride, feature_size, dropRate):
        ...
        for i in range(int(nb_layers)):
            layers.append(
                block(i == 0 and in_planes or out_planes, out_planes, i == 0 and stride or 1, feature_size, dropRate))
        return nn.Sequential(*layers)
