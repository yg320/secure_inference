...
out_path = "/storage/yakir/secure_inference/outputs/distortions/segmentation/baseline/deeplabv3_m-v2-d8_512x512_160k_ade20k_collected_32"
layer_names = [
                "conv1",
                "layer1_0_0",
                "layer2_0_0",
...
for layer_name in tqdm(layer_names):
    files = [os.path.join(input_path, f"{layer_name}_{batch_index}.pickle") for batch_index in range(2)]
