...
plt.yticks(np.arange(0, r.shape[0] - 2*CROP, 2))
plt.gca().set_yticklabels(np.arange(-31+CROP, 32-CROP, 2), fontsize=15)
plt.gca().set_xticklabels(np.arange(-31+CROP, 32-CROP, 2), fontsize=15)
cbar = plt.colorbar()
