...
runtime_cifar_baseline = 1357235088
runtime_imnet_baseline = 17478334016
runtime_ade20_baseline = 64005736576
runtime_voc12_baseline = 106205953664

runtime_cifar_16 = np.array([566001920, 578446528, 589733760, 601267480, 612290712, 623566328])
runtime_cifar_64 = np.array([579236240, 604916752, 629439888, 654208720, 678467856, 702979376])
runtime_imnet_16 = np.array([2341120540, 2544648634, 2741103970, 2934551686, 3126430912, 3318121840])
runtime_imnet_64 = np.array([2569422460, 3001253266, 3426011314, 3847761742, 4267943680, 4687915408])
runtime_ade20_32 = np.array([6341935552, 7542829312, 8724150656, 9879281600, 11035320000, 12158112960])
runtime_ade20_64 = np.array([7004879488, 8858244736, 10692626048, 12500557952, 14310337152, 16085475456])
runtime_voc12_32 = np.array([12305108608, 14874560576, 17276690368, 19699197824, 22078597056, 24376760064])
runtime_voc12_64 = np.array([13765095040, 17783405696, 21574989952, 25407395456, 29186553984, 32841516672])
...
boost_imnet_app = runtime_imnet_baseline / runtime_imnet_16
boost_cifar_app = runtime_cifar_baseline / runtime_cifar_16
boost_ade20_app = runtime_ade20_baseline / runtime_ade20_32
boost_voc12_app = runtime_voc12_baseline / runtime_voc12_32

boost_imnet_no_app = runtime_imnet_baseline / runtime_imnet_64
boost_cifar_no_app = runtime_cifar_baseline / runtime_cifar_64
boost_ade20_no_app = runtime_ade20_baseline / runtime_ade20_64
boost_voc12_no_app = runtime_voc12_baseline / runtime_voc12_64
...
plt.scatter(boost_ade20_app, boost_ade20_no_app, color=green)
plt.scatter(boost_voc12_app, boost_voc12_no_app, color=purple)
plt.scatter(boost_imnet_app, boost_imnet_no_app, color=blue)
plt.scatter(boost_cifar_app, boost_cifar_no_app, color=red)
plt.plot([0,10], [0, 10], "--", color="black", lw=plot_lw)
