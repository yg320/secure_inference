...
class JobFetcher:
    ...
    def job(self):
        ...
        ratio = 0.1
        iter_to_checkpoint = ["/home/yakir/PycharmProjects/secure_inference/work_dirs/m-v2_256x256_ade20k/baseline/iter_160000.pth",
                              "/home/yakir/PycharmProjects/secure_inference/work_dirs/m-v2_256x256_ade20k/baseline/iter_160000.pth"]
        ...
        base_output_path = f"/home/yakir/Data2/assets_v4/distortions/ade_20k_256x256/MobileNetV2/benchmark"
