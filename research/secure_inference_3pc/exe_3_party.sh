...
#CHECKPOINT=/home/yakir/PycharmProjects/secure_inference/work_dirs/baseline_0.06/epoch_120.pth
#RELU_SPEC_FILE=/home/yakir/deepreduce_comparison_v3/distortions/baseline/block_sizes/0.06.pickle
#SECURE_CONFIG_PATH=/home/yakir/PycharmProjects/secure_inference/work_dirs/baseline_0.06/baseline_0.06.py

#CHECKPOINT=/home/yakir/assets/mobilenet_ade/models/ratio_0.15.pth
#RELU_SPEC_FILE=/home/yakir/assets/mobilenet_ade/block_spec/0.15.pickle
...
export PYTHONPATH="." ; python research/secure_inference_3pc/parties/client/run.py --relu_spec_file $RELU_SPEC_FILE --secure_config_path $SECURE_CONFIG_PATH  --image_start 0 --image_end 10 --skip_existing --dump_dir /home/yakir/tmptmptmp_seg &
#1449
