...
class Conv2DHandler:
    ...
    def conv2d_torch_4_type_1(self, a, b, stride, padding, dilation, groups, dtype=torch.float32):
        ...
        res_float += (torch.conv2d(x0, y1, **kwargs) + torch.conv2d(x1, y0, **kwargs)).to(torch.int64) << 4
        res_float += (torch.conv2d(x0, y2, **kwargs) + torch.conv2d(x1, y1, **kwargs) + torch.conv2d(x2, y0, **kwargs)).to(torch.int64) << 8
        res_float += (torch.conv2d(x0, y3, **kwargs) + torch.conv2d(x1, y2, **kwargs) + torch.conv2d(x2, y1, **kwargs) + torch.conv2d(x3, y0, **kwargs)).to(torch.int64) << 12
        res_float += (torch.conv2d(x0, y4, **kwargs) + torch.conv2d(x1, y3, **kwargs) + torch.conv2d(x2, y2, **kwargs) + torch.conv2d(x3, y1, **kwargs) + torch.conv2d(x4, y0, **kwargs)).to(torch.int64) << 16
        res_float += (torch.conv2d(x0, y5, **kwargs) + torch.conv2d(x1, y4, **kwargs) + torch.conv2d(x2, y3, **kwargs) + torch.conv2d(x3, y2, **kwargs) + torch.conv2d(x4, y1, **kwargs) + torch.conv2d(x5, y0, **kwargs)).to(torch.int64) << 20
        res_float += (torch.conv2d(x0, y6, **kwargs) + torch.conv2d(x1, y5, **kwargs) + torch.conv2d(x2, y4, **kwargs) + torch.conv2d(x3, y3, **kwargs) + torch.conv2d(x4, y2, **kwargs) + torch.conv2d(x5, y1, **kwargs) + torch.conv2d(x6, y0, **kwargs)).to(torch.int64) << 24
        res_float += (torch.conv2d(x0, y7, **kwargs) + torch.conv2d(x1, y6, **kwargs) + torch.conv2d(x2, y5, **kwargs) + torch.conv2d(x3, y4, **kwargs) + torch.conv2d(x4, y3, **kwargs) + torch.conv2d(x5, y2, **kwargs) + torch.conv2d(x6, y1,**kwargs) + torch.conv2d(x7, y0, **kwargs)).to(torch.int64) << 28
        res_float += (torch.conv2d(x0, y8, **kwargs) + torch.conv2d(x1, y7, **kwargs) + torch.conv2d(x2, y6, **kwargs) + torch.conv2d(x3, y5, **kwargs) + torch.conv2d(x4, y4, **kwargs) + torch.conv2d(x5, y3, **kwargs) + torch.conv2d(x6, y2, **kwargs) + torch.conv2d(x7, y1, **kwargs) + torch.conv2d(x8, y0, **kwargs)).to(torch.int64) << 32
        res_float += (torch.conv2d(x0, y9, **kwargs) + torch.conv2d(x1, y8, **kwargs) + torch.conv2d(x2, y7, **kwargs) + torch.conv2d(x3, y6, **kwargs) + torch.conv2d(x4, y5, **kwargs) + torch.conv2d(x5, y4, **kwargs) + torch.conv2d(x6, y3, **kwargs) + torch.conv2d(x7, y2, **kwargs) + torch.conv2d(x8, y1, **kwargs) + torch.conv2d(x9, y0, **kwargs)).to(torch.int64) << 36
        res_float += (torch.conv2d(x0, y10, **kwargs) + torch.conv2d(x1, y9, **kwargs) + torch.conv2d(x2, y8, **kwargs) + torch.conv2d(x3, y7, **kwargs) + torch.conv2d(x4, y6, **kwargs) + torch.conv2d(x5, y5, **kwargs) + torch.conv2d(x6, y4, **kwargs) + torch.conv2d(x7, y3, **kwargs) + torch.conv2d(x8, y2, **kwargs) + torch.conv2d(x9, y1, **kwargs) + torch.conv2d(x10, y0, **kwargs)).to(torch.int64) << 40
        res_float += (torch.conv2d(x0, y11, **kwargs) + torch.conv2d(x1, y10, **kwargs) + torch.conv2d(x2, y9, **kwargs) + torch.conv2d(x3, y8, **kwargs) + torch.conv2d(x4, y7, **kwargs) + torch.conv2d(x5, y6, **kwargs) + torch.conv2d(x6, y5, **kwargs) + torch.conv2d(x7, y4, **kwargs) + torch.conv2d(x8, y3, **kwargs) + torch.conv2d(x9, y2, **kwargs) + torch.conv2d(x10, y1, **kwargs) + torch.conv2d(x11, y0, **kwargs)).to(torch.int64) << 44
        res_float += (torch.conv2d(x0, y12, **kwargs) + torch.conv2d(x1, y11, **kwargs) + torch.conv2d(x2, y10, **kwargs) + torch.conv2d(x3, y9, **kwargs) + torch.conv2d(x4, y8, **kwargs) + torch.conv2d(x5, y7, **kwargs) + torch.conv2d(x6, y6, **kwargs) + torch.conv2d(x7, y5, **kwargs) + torch.conv2d(x8, y4, **kwargs) + torch.conv2d(x9, y3, **kwargs) + torch.conv2d(x10, y2, **kwargs) + torch.conv2d(x11, y1, **kwargs) + torch.conv2d(x12, y0, **kwargs)).to(torch.int64) << 48
        res_float += (torch.conv2d(x0, y13, **kwargs) + torch.conv2d(x1, y12, **kwargs) + torch.conv2d(x2, y11, **kwargs) + torch.conv2d(x3, y10, **kwargs) + torch.conv2d(x4, y9, **kwargs) + torch.conv2d(x5, y8, **kwargs) + torch.conv2d(x6, y7, **kwargs) + torch.conv2d(x7, y6, **kwargs) + torch.conv2d(x8, y5, **kwargs) + torch.conv2d(x9, y4, **kwargs) + torch.conv2d(x10, y3, **kwargs) + torch.conv2d(x11, y2, **kwargs) + torch.conv2d(x12, y1, **kwargs) + torch.conv2d(x13, y0, **kwargs)).to(torch.int64) << 52
        res_float += (torch.conv2d(x0, y14, **kwargs) + torch.conv2d(x1, y13, **kwargs) + torch.conv2d(x2, y12, **kwargs) + torch.conv2d(x3, y11, **kwargs) + torch.conv2d(x4, y10, **kwargs) + torch.conv2d(x5, y9, **kwargs) + torch.conv2d(x6, y8, **kwargs) + torch.conv2d(x7, y7, **kwargs) + torch.conv2d(x8, y6, **kwargs) + torch.conv2d(x9, y5, **kwargs) + torch.conv2d(x10, y4, **kwargs) + torch.conv2d(x11, y3, **kwargs) + torch.conv2d(x12, y2, **kwargs) + torch.conv2d(x13, y1, **kwargs) + torch.conv2d(x14, y0, **kwargs)).to(torch.int64) << 56
        res_float += (torch.conv2d(x0, y15, **kwargs) + torch.conv2d(x1, y14, **kwargs) + torch.conv2d(x2, y13, **kwargs) + torch.conv2d(x3, y12, **kwargs) + torch.conv2d(x4, y11, **kwargs) + torch.conv2d(x5, y10, **kwargs) + torch.conv2d(x6, y9, **kwargs) + torch.conv2d(x7, y8, **kwargs) + torch.conv2d(x8, y7, **kwargs) + torch.conv2d(x9, y6, **kwargs) + torch.conv2d(x10, y5, **kwargs) + torch.conv2d(x11, y4, **kwargs) + torch.conv2d(x12, y3, **kwargs) + torch.conv2d(x13, y2, **kwargs) + torch.conv2d(x14, y1, **kwargs) + torch.conv2d(x15, y0, **kwargs)).to(torch.int64) << 60
