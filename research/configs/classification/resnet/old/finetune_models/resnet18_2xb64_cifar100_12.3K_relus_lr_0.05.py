...
lr_config = dict(policy='step', step=[30, 60, 90], gamma=0.1, min_lr=0.0001, warmup='linear', warmup_ratio=0.01, warmup_iters=5, warmup_by_epoch=True)
runner = dict(type='EpochBasedRunner', max_epochs=100)


relu_spec_file = "/home/yakir/distortion_200/block_size/12.3K.pickle"
