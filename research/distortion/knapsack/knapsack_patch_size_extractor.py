...
if __name__ == "__main__":
    ...
    parser.add_argument('--block_size_spec_file_name', type=str, default="/home/yakir/deepreduce_comparison_v2/distortions/baseline/block_sizes/229.38K.pickle")
    parser.add_argument('--channel_distortion_path', type=str, default="/home/yakir/deepreduce_comparison_v2/distortions/baseline/distortion_collected/")
    parser.add_argument('--config', type=str, default="/home/yakir/PycharmProjects/secure_inference/research/configs/classification/resnet/resnet18_cifar100/baseline.py")
    parser.add_argument('--ratio', type=float, default=None)
    parser.add_argument('--max_cost', type=int, default=229380)
