...
# TODO: There is a plenty of code duplication between this class and ResNet18/50_Utils.
class ResNet18_CIFAR_Utils(ArchUtils):
    def __init__(self):
        super(ResNet18_CIFAR_Utils, self).__init__()
