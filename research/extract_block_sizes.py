...
parser.add_argument('--output_path', type=str, default="/home/yakir/tmptmptmp")
parser.add_argument('--num_samples', type=int, default=4)
parser.add_argument('--num_gpus', type=int, default=2)

args = parser.parse_args()

distortion_extractor_script = os.path.join(os.path.dirname(__file__), "distortion_extractor.py")
