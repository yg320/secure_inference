...
import numpy as np
import time
from research.block_relu.consts import BLOCK_SIZES, LAYER_NAMES, LAYER_NAME_TO_CHANNELS, LAYER_NAME_TO_BLOCK_NAME, \
    BLOCK_NAMES, NETWORK_MULTI_BLOCK_SPEC
...
def main():
    ...
    with torch.no_grad():
        ...
        # expected_time = 0
        for layer_index, layer_name in enumerate(LAYER_NAMES[::-1]):
